            ...
            <section class="page active">
                <div class="tool-page">
                    ...
                    <div class="settings-group">
                        ...
                        <label>
                            <input type="checkbox" id="aspectLock"> Lock Aspect
                        </label>
                        <label>
                    ...
                    <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                        <button class="btn btn-primary" id="applyCropBtn">✂️ Apply Crop</button>
                        <button class="btn btn-secondary" id="resetCropBtn">↺ Reset</button>
                        <button class="btn btn-success" id="downloadCropBtn" disabled>📥 Download Cropped</button>
                    </div>

                    <div id="cropInfo" style="margin-top: 15px; padding: 10px; background: #f5f5f5; border-radius: 8px;">
                        No selection made. Click and drag on the image to select crop area.
                    </div>

                    <div class="preview-area" id="cropPreview" style="margin-top: 15px; display: none;">
...
// Make CropToolController globally available
